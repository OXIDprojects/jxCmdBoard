...
array_push( $aIncModules, array("title"  => array('de' => 'Amazon Export',
                                                  'en' => 'Amazon Export'), 
                                "button" => array('de' => 'CSV Datei erzeugen',
                                                  'en' => 'Create CSV File'),
                                "desc"   => array('de' => 'Export aller als aktiv geschalteter Artikel. Der Export wird im Verzeichnis /export in der Datei azex-nnnn.txt gespeichert.',
                                                  'en' => 'Export of all  active products. The export will be save in the folder /export in file azex-nnnn.txt.'),
                                "link"   => array('de' => "{$sShopUrl}modules/marm/csvexporter/exporter/amazon/amazonExporter.php",
                                                  'en' => "{$sShopUrl}modules/marm/csvexporter/exporter/amazon/amazonExporter.php"),
                                "target" => '_blank'
                                ));

...
array_push( $aIncModules, array("title"  => array('de' => 'Preisroboter Export',
                                ...
                                "button" => array('de' => 'CSV Datei erzeugen',
                                                  'en' => 'Create CSV File'),
                                "desc"   => array('de' => 'Export aller als aktiv geschalteter Artikel. Der Export wird im Verzeichnis /export in der Datei google.xml gespeichert.',
                                                  'en' => 'Export of all  active products. The export will be save in the folder /export in file google.xml.'),

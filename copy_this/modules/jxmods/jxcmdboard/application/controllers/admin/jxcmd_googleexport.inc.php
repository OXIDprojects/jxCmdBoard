...
array_push( $aIncModules, array("title"  => array('de' => 'Google Productfeed Export',
                                ...
                                "desc"   => array('de' => 'Export aller als aktiv geschalteter Artikel. Der Export wird im Verzeichnis /export in der Datei ggex-nnnn.txt gespeichert.',
                                                  'en' => 'Export of all  active products. The export will be save in the folder /export in file ggex-nnnn.txt.'),
                                "link"   => array('de' => "{$sShopUrl}modules/marm/csvexporter/exporter/google/marmGoogleExporter.php",
                                                  'en' => "{$sShopUrl}modules/marm/csvexporter/exporter/google/marmGoogleExporter.php"),
                                "target" => '_blank'
                                ));
